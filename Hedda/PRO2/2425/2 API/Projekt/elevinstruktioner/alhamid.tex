...
\begin{center}
	\begin{tabular}{ll}
		...
		invånare 25-64 år med förgymnasial utbildning, andel (\%) & N01984\\
		invånare 25-64 år med eftergymnasial utbildning, andel (\%)	& N01982
	\end{tabular}
\end{center}

Datan ska presenteras med ett linjediagram. Dessutom ska du plotta andelen med gymnasial utbildning i ett tredje linjediagram.
