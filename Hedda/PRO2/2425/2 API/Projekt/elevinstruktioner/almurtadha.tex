...
Du ska presentera följande data från Kiruna kommun (kommunkod 2584):

\begin{center}
	\begin{tabular}{ll}
		\rowcolor{blue!25}
		\textbf{Nyckeltal} & \textbf{KPI}\\
		förskrivna rollatorer, antal &	N79726\\
		förskrivna manuella tvåhjulsdrivna rullstolar, antal	& N79729
	\end{tabular}
\end{center}

Datan ska presenteras med två linjediagram. Dessutom ska du plotta summan av de förskrivna hjälpmedlena i ett tredje linjediagram.
