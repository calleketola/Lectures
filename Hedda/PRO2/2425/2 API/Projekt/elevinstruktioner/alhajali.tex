...
Du ska presentera följande data från Göteborgs kommun (kommunkod 1480):

\begin{center}
	\begin{tabular}{ll}
		\rowcolor{blue!25}
		\textbf{Nyckeltal} & \textbf{KPI}\\
		månadsavlönade totalt, kommun, antal & N00053\\
		månadsavlönade inom teknikarbete, kommun, antal	& N00110\\
	\end{tabular}
\end{center}

Datan ska presenteras med ett linjediagram. Dessutom ska du plotta andelen av de månadsavlönade som jobbar inom teknikarbete i ett tredje linjediagram.
