lista_med_tal = [6,4,1,9,4,2,7,5,2,3,7,2,1,9,5,10,2,3,9] # Detta är en samling av värden
i = 0
print(lista_med_tal) # Skriver ut all värden tillsammans
while i < len(lista_med_tal):
    print(lista_med_tal[i]) # Kommer att skriva ut värdena ett och ett
    i += 1
